...
serBtn.addEventListener('click', e => {
  e.preventDefault();
  console.log(inventario.listadoInv());
...
bAdd.addEventListener('click', event => {
  ...
  const p = new Producto(inputsAdd.nombreP.value, inputsAdd.cantidadP.value, inputsAdd.costoP.value, inputsAdd.codigoP.value);
...
const producto = new Producto("Guayaba", 50, 30);
